...
ani04_1.from(".intro .introduce-character", 1, {
  opacity: 0, // 시작값 0
  delay: 0,
  y: 300, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
ani04_1.from(".kid .value-kid-tablet-2", 1, {
  opacity: -1, // 시작값 0
  delay: 0.4,
  y: "-35vh", // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
ani04_1.from(".parent .value-parent-phone-2", 1, {
  opacity: -1, // 시작값 0
  delay: 0.4,
  x: "-35vh", // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
// ani04_4.from(".bottom-trigger .color-bottom", 0.4, {
//   // 기존 duration 값 사용
//   opacity: 0,
//   delay: 0,
//   y: "15vh",
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .app-comp-1", 0.5, {
  opacity: 0, // 시작값 0
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .app-comp-2", 0.5, {
  opacity: 0, // 시작값 0
  delay: 0.2, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .line-1", 0.5, {
  opacity: 0, // 시작값 0
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .logo-kid-text-1", 1, {
  opacity: -1, // 시작값 0
  delay: 0.3,
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .app-comp-3", 0.5, {
  opacity: 0, // 시작값 0
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .line-2", 0.5, {
  opacity: 0, // 시작값 0
  delay: 0.7, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .habit-icon", 0.5, {
  opacity: 0, // 시작값 0
  delay: 0.8, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .logo-kid-text-2", 0.5, {
  opacity: 0, // 시작값 0
  delay: 0.8, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
  // x: "-10vh",
});
...
ani04_1.from(".mockup-1 img", 1, {
  opacity: -1, // 시작값 0
  delay: 0,
  y: "25vh", // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
ani04_1.from(".mockup-2 img", 1, {
  opacity: -1, // 시작값 0
  delay: 0,
  x: "-25vh", // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
