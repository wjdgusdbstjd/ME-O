...
ani04_1.from(".logo-left-img .logo-kid-text-1", 1, {
  opacity: -1, // 시작값 0
  delay: 1,
  x: "-13vh", // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
ani04_1.from(".logo-left-img .app-comp-3", 1, {
  opacity: 0, // 시작값 0
  delay: 1.8, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
ani04_1.from(".logo-left-img .habit-icon", 1, {
  opacity: 0, // 시작값 0
  delay: 2.1, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
});
...
var ani04_1 = gsap.timeline();
ani04_1.from(".logo-left-img .logo-kid-text-2", 1, {
  opacity: 0, // 시작값 0
  delay: 2.4, // 작아진 상태에서 시작 (0.5는 반으로 작아짐)
  x: "-10vh",
});
